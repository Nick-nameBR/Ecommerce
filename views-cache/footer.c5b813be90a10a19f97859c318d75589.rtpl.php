                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        ...
                        <div class="footer-social">
                            <a href="https://www.facebook.com/nikolas.moreira.505" target="_blank"><i class="fa fa-facebook"></i></a>
                            <a href="https://www.linkedin.com/in/nikolas-moreira-6b34691b2/" target="_blank"><i class="fa fa-linkedin"></i></a>
                            <a href="https://github.com/Nick-nameBR" target="_blank"><i class="fa fa-github"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2022 <a href="https://github.com/Nick-nameBR" target="_blank">Nikolas Santos</a></p>
                    </div>
                </div>
